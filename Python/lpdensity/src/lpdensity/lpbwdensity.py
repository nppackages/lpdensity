...
class bw_output:
    ...
    def __repr__(self):
        ...
        for j in range(self.ng):
            print(
                str(j + 1).ljust(fw_c),
                str(round(self.table["grid"][j], n_dec)).rjust(fw_c),
                str(round(self.table["bw"][j], n_dec)).rjust(fw_l),
                str(int(self.table["nh"][j])).rjust(fw_c),
                str(int(self.table["nhu"][j])).rjust(fw_c),
            )
        print("=" * 65)
        return ""
