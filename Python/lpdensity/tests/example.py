...
est = lpdensity(data=jtpa_notreat['logincome'], bwselect='imse-dpi', grid=grid, kernel="triangular")
est2 = lpdensity(data=jtpa_notreat['logincome'], bwselect="imse-dpi", grid=grid, Cweights=jtpa_notreat['hsorged'])
est3 = lpdensity(data=jtpa_notreat['logincome'], bwselect="imse-dpi", grid=grid, Cweights=jtpa_notreat['hsorged'])
print(type(est3))
